---
title: "EDS241 Week1 Lab: Simulations of consistency of OLS and omitted variable bias"
...
# Generate X1 and u
X1 <- runif(bigN, min = 0, max = 10) # uniform random variable
u <- rnorm(bigN, mean = 0, sd = 4) # creates normal distribution
